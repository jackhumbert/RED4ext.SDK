...
/// @pattern 33 C0 C6 01 00 48 89 41 18 89 41 14 48 8B C1 C3
using CString_Initialize = CString* (CString* str);

// @pattern 48 89 5C 24 08 48 89 6C 24 10 48 89 74 24 18 57 41 56 41 57 48 81 EC C0 00 00 00 48 8B BC 24 00
using CreateUpdateDefintionFromParent = void* (DynArray<void *>, uint8_t, CClass*, char*, void*, uint32_t);
