...
struct ProxyManager
{
    ...
    inline static ProxyManager * Get() {
        return RED4ext::UniversalRelocPtr<ProxyManager *>(37956006);
    }
...
/// @eval ptr
// static inline ProxyManager * proxyManager = RED4ext::UniversalRelocPtr<ProxyManager *>(37956006);
