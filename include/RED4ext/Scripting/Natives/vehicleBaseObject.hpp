...
//    static Handle<RED4ext::ent::AnimatedComponent>  GetAnimatedComponentWithName(Handle<RED4ext::ent::AnimatedComponent> *handle, RED4ext::vehicle::BaseObject *vehicle, RED4ext::CName name);
    ...
    struct Input { // 264
      ...
      uint8_t vehicleCamera34;
      uint8_t unk35;
      uint8_t unk36;
      uint8_t vehicleInverseCameraToggle;
      uint8_t vehicleInverseCameraToggle2;
      uint8_t vehicleCameraReset;
      uint8_t unk3A;
      uint8_t cameraAimMaybe;
      uint8_t unk3C;
      uint8_t unk3D;
      uint8_t unk3E;
      uint8_t unk3F;
    ...
    Handle<MeshParamsRegistry> meshParamsRegistry;
    // float unk618;
...
RED4EXT_ASSERT_OFFSET(BaseObject, autonomousData, 0x860);
RED4EXT_ASSERT_OFFSET(BaseObject, destruction_related, 0xA20);
